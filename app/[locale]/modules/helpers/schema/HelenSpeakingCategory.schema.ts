...
export type HelenSpeakingCategorySchema = InferType<typeof formSchema>;

export function useFormHelenSpeakingCategory() {
  const form = useForm<HelenSpeakingCategorySchema>({
  ...
  return {
    form,
    formSchema,
    isError: isError<HelenSpeakingCategorySchema>(form),
    getErrorMessage: getErrorMessage<HelenSpeakingCategorySchema>(form),
  };
}
