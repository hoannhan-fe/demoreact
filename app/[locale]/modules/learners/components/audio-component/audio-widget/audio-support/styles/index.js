const styles = {
  ...
  h1Section:
    'lg:text-[24px] md:text-[20px] sm:text-[16px] text-[12px] lg:leading-[100px] md:leading-[100px] sm:leading-[74.4px] leading-[64.4px] text-secondary-white font-Silk_Serif ',
  bgText:
